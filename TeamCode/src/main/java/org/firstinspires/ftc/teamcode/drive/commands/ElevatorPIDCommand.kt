...
class ElevatorPIDCommand(elevator: Elevator, setpoint: Double): CommandBase() {
    ...
    override fun isFinished(): Boolean {
        return if (setpoint == Elevator.BOTTOM) {
            elevator.atBottomSetPoint()
        } else {
            elevator.atSetPoint()
        }
    }
