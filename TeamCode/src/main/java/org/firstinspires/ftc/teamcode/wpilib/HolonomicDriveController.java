...
public class HolonomicDriveController {
  ...
  private final WpilibPIDController m_xController;
  private final WpilibPIDController m_yController;
  ...
  public HolonomicDriveController(
      WpilibPIDController xController, WpilibPIDController yController, ProfiledPIDController thetaController) {
   ...
   */
  public WpilibPIDController getXController() {
   ...
   */
  public WpilibPIDController getYController() {
