...
public class KookySwerveModule {
    ...
    public KookySwerveModule(DcMotorEx m, CRServo s, AbsoluteAnalogEncoder e) {
        motor = m;
    ...
    public KookySwerveModule(HardwareMap hardwareMap, String mName, String sName, String eName) {
        this(hardwareMap.get(DcMotorEx.class, mName),
                hardwareMap.get(CRServo.class, sName),
                new AbsoluteAnalogEncoder(hardwareMap, eName, 0.0));
    }
    ...
    public static class SwerveModuleState {
        public KookySwerveModule module;
        public double wheelPos, podRot;

        public SwerveModuleState(KookySwerveModule s) {
            module = s;
            wheelPos = 0;
            podRot = 0;
        }
        ...
        public Vector2d calculateDelta() {
            ...
            update();
            double r = wheelPos - oldWheel;
            double x = r * Math.cos(podRot);
            double y = r * Math.sin(podRot);
