...
class DriveTime(drivebase: SwerveDrivebase, chassisSpeeds: ChassisSpeeds, seconds: Double): CommandBase() {
    ...
    override fun initialize() {
         ...
         */
        chassisSpeeds = ChassisSpeeds(chassisSpeeds.vxMetersPerSecond*DrivebaseConstants.Measurements.MAX_VELOCITY,
            chassisSpeeds.vyMetersPerSecond*DrivebaseConstants.Measurements.MAX_VELOCITY,
            chassisSpeeds.omegaRadiansPerSecond*DrivebaseConstants.Measurements.MAX_ANGULAR_VELOCITY)
    }
    ...
    override fun execute() {
        ...
        drivebase.kinematicsDrive(chassisSpeeds)
    }
    ...
    override fun isFinished(): Boolean {
        ...
        return (currentTime/1E9 - startTime/1E9) > seconds
    }
