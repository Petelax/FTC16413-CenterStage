...
public class ProfiledPIDController {
  ...
  private WpilibPIDController m_controller;
  ...
  /**
   * Allocates a ProfiledWpilibPIDController with the given constants for Kp, Ki, and Kd.
   *
  ...
  public ProfiledPIDController(
    ...
    m_controller = new WpilibPIDController(Kp, Ki, Kd, period);
  ...
  /**
   * Sets the goal for the ProfiledWpilibPIDController.
   *
  ...
  /**
   * Gets the goal for the ProfiledWpilibPIDController.
   *
   * @return The goal.
   */
  ...
  /**
   * Returns the current setpoint of the ProfiledWpilibPIDController.
   *
  ...
  /**
   * Returns the next output of the WpilibPIDController.
   *
   * @param measurement The current measurement of the process variable.
   * @param goal The new goal of the controller.
   * @return The controller's next output.
