...
class LegacySwerveModule(hardwareMap: HardwareMap, driveMotorID: String, turnMotorID: String, encoderID: String, encoderOffset: Double = 0.0, direction: DcMotorSimple.Direction = DcMotorSimple.Direction.REVERSE) {
    ...
    private var encoder: AbsoluteAnalogEncoder = AbsoluteAnalogEncoder(hardwareMap, encoderID, encoderOffset)
    ...
    private fun getModuleRotation(): Double {
        return encoder.getDegrees()*PI/180.0
    }

    fun update() {
        currentAngle = encoder.getDegrees()
